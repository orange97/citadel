...
$newanchorpoint = strtolower(preg_replace('/[^a-zA-Z]/s', '', $post->post_title)); 
...
?>
<section id="<?php echo $new_title; ?>" class="single_post_bg" style="background:url(<?php echo $ren_directive_icon; ?>) <?php echo $ren_bg_color; ?> center top no-repeat !important;">
...
<section class="pagebottom" style="background:<?php echo $ren_bg_color; ?>">
