...
$output = '<div id="gallery_'.$rand_id.'" class="w-gallery'.$el_class.$type_classes.$masonry_class.$indents_class.'"> <div class="w-gallery-tnails">';
...
if (is_array($attachments))
{
	foreach ($attachments as $id => $attachment) {
		...
		$output .= '<span class="w-gallery-tnail-title">'.$title.'</span>';
