...
$us_zilla_shortcodes['social_links'] = array(
	...
	'shortcode' => '[vc_social_links size="{{size}}" email="{{email}}" facebook="{{facebook}}" twitter="{{twitter}}" google="{{google}}" linkedin="{{linkedin}}" youtube="{{youtube}}" flickr="{{flickr}}" instagram="{{instagram}}" deviantart="{{deviantart}}" foursquare="{{foursquare}}" github="{{github}}" behance="{{behance}}" xing="{{xing}}" pinterest="{{pinterest}}" skype="{{skype}}" tumblr="{{tumblr}}" dribbble="{{dribbble}}" vk="{{vk}}" rss="{{rss}}"]',
